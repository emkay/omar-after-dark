...
Intro.prototype.create = function create () {
  const self = this
  ...
  this.tide = this.game.add.sprite(0, 80, 'intro_tide')
  this.tide.animations.add('go', [0, 1, 2])
...
Intro.prototype.update = function update () {
  this.updateOmar()
  this.updateBrad()
  this.tide.animations.play('go', 1)
}

Intro.prototype.updateBrad = function updateBrad () {
  if (this.brad) {
...
Intro.prototype.updateOmar = function updateOmar () {
  const camera = this.game.camera
